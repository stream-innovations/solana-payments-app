...
Refunds are processed on the [Solana Pay merchant portal](https://merchant.solanapayments.app). This portal can be accessed from your Shopify store settings by clicking Manage on the Solana Pay payment method.
